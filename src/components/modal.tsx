        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="flex-shrink-0 w-full md:w-auto h-auto md:h-[435px] lg:h-[405px]">
            <img
              src={image}
              alt={title}
              className="w-full max-h-[320px] h-[180px] md:max-h-full md:h-full md:w-[320px] object-cover object-top md:object-center rounded-t-lg md:rounded-r-none md:rounded-l-lg"
            />
          </div>
          {/* TEXT */}
          <div className="p-6 flex flex-col gap-2">
            ...
            <div>
              <a
                href={buttonLink}
                target="_blank"
                className="group flex flex-row items-center gap-3 w-full px-6 py-2.5 rounded-full border border-gold justify-center sm:w-fit transition-all duration-300 ease-in-out cursor-pointer hover:bg-gold hover:shadow-sm"
              >
                <span className="text-gold font-inter text-md special:text-lg group-hover:text-white">
                  {buttonText}
                </span>
