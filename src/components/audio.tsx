...
const AudioButton = () => {
  ...
  return (
    <button
      onClick={togglePlay}
      className="group flex items-center justify-center size-10 bg-transparent border-2 border-white rounded-full transition-all duration-250 ease-in-out hover:size-12"
    >
